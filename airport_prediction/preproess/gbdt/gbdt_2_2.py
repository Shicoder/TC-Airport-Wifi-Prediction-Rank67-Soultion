...
print hour1_mean_dict['E1-<E1-1A-1>-15:10']
direction = "../merge_10/"
...
test = np.loadtxt(open("../gbdt_feat/SPSS_feature_pro_gbdt2_2.csv","rb"),delimiter=",",skiprows=0)
import numpy as np
print "predicting"
test=np.array(test)
...
f = open("../submit/gbdt_result_spss_2_j3_addm.csv", "wb")
write = csv.writer(f)
