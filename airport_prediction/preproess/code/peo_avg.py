...
#
# train_feat = pd.read_csv('D:/Shi/python/3/10_19/train_feat.csv', sep=',', index_col='BGATEtime')
# gbdt_feat_target = pd.read_csv('D:/Shi/python/3/10_19/gbdt_feat_target.csv', sep=',', index_col='BGATEtime')
# for g in range(0, len(arealist)):
#     train= pd.read_csv('D:/Shi/python/3/10_19/aindaa/%s.csv'%arealist[g], sep=',',index_col='BGATEtime')
#     gbdt_feat= pd.read_csv('D:/Shi/python/3/10_19/esdaa/%s.csv'%arealist[g], sep=',',index_col='BGATEtime')
#     train_feat=train_feat.join(train)
#     gbdt_feat_target=gbdt_feat_target.join(gbdt_feat)
#     train_feat.to_csv("D:/Shi/python/3/10_19/train_feat2.csv")
#     gbdt_feat_target.to_csv("D:/Shi/python/3/10_19/gbdt_feat_target2.csv")
train_feat = pd.read_csv('D:/Shi/python/3/10_19/train_feat2.csv', sep=',', index_col='BGATEtime')
gbdt_feat_target = pd.read_csv('D:/Shi/python/3/10_19/gbdt_feat_target2.csv', sep=',', index_col='BGATEtime')
train_feat.fillna(0)
gbdt_feat_target.fillna(0)
train_feat.to_csv("D:/Shi/python/3/10_19/train_feat2.csv",index=False,header=None)
gbdt_feat_target.to_csv("D:/Shi/python/3/10_19/gbdt_feat_target2.csv",index=False,header=None)
#         numdae = []
#         num = 1
#         sum = 0
#         srr = arealist[g]
