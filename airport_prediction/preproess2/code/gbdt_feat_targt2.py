...
pjf_feat_target=cPickle.load(open("../pjf_feat_train_quyurenshu.pkl","rb"))
...
for file_name in file_list:
    ...
    for i in range(18):
        time=15+(i/6)
        minte=i%6
        meidian_key = wifi_name_dict[int(file_name.split(".")[0])]+"-"+str(i+1)
...
print len(features)
f=open("../gbdt_feat/xgboost_target.csv","wb")
write = csv.writer(f)
