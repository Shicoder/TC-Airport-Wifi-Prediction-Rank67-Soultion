...
for file_name in file_list:
    ...
    t250 = t250_hour_dict[wifi_name_dict[int(file_name.split(".")[0])]+":25"]
    s2_key = wifi_name_dict[int(file_name.split(".")[0])]+":25-13"
...
print len(features)
f=open("../gbdt_feat/gbdt2_3_class_feat_online.csv","wb")
write = csv.writer(f)
