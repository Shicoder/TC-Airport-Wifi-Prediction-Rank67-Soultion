...
test = np.loadtxt(open("../gbdt_feat/gbdt2_4_2_feat_q2_lable_ph_add_250.csv","rb"),delimiter=",",skiprows=0)
import numpy as np
print "predicting"
test=np.array(test)
...
f = open("../submit/gbdt2_4_2_result_3_withq2_lableph_add250_meidian.csv", "wb")
write = csv.writer(f)
