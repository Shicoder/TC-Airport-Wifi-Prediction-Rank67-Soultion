...
clf2=GradientBoostingRegressor(n_estimators=1000,learning_rate=0.1,max_depth=10,max_features=10)
...
test = np.loadtxt(open("../gbdt_feat/gbdt2_2_feat_no_mean.csv","rb"),delimiter=",",skiprows=0)
import numpy as np
print "predicting"
test=np.array(test)
